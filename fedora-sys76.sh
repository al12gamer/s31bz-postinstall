...
# add szydell for system76 hardware
...
# system76 work for system76 hardware
sudo systemctl enable dkms -yq
sudo systemctl enable --now system76-firmware-daemon -yq
sudo gpasswd -a $USER adm
sudo systemctl enable system76-power system76-power-wake -yq
